interface PerksComponentProps {
    selected: string[];
    onChange: (selected: string[]) => void;
}

const PerksComponent: React.FC<PerksComponentProps> = ({ selected = [], onChange }) => {

    function handleCheckboxClick(ev: React.ChangeEvent<HTMLInputElement>) {
