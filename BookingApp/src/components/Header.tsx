...
export default function Header(){
  ...
  // }
    ...
    return (
        ...
        <div className='flex items-center gap-2 border border-grey-300 rounded-full py-2 px-4 shadow-md shadow-gray-300'>
          <div>Anywhere</div>
        ...
        <Link to={user?'/account':'/login'} className='flex items-center gap-2 border border-grey-300 rounded-full py-2 px-4 shadow-md'>
